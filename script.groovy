...
def pushToNexus() {
   echo "pushing the jar file to Nexus maven-snapshots repo..."
    ...
    nexusArtifactUploader artifacts: [[artifactId: 'project-devops', classifier: '', file: 'uber.jar', type: 'jar']], credentialsId: '', groupId: 'com.example', nexusUrl: 'localhost:8081', nexusVersion: 'nexus3', protocol: 'http', repository: '', version: '0.0.1-SNAPSHOT'
}
