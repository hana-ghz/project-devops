...
def pushToNexus() {
   echo "pushing the jar file to Nexus maven-snapshots repo..."
    ...
    nexusArtifactUploader artifacts: [[artifactId: 'project-devops', classifier: '', file: 'target/Uber.jar', type: 'jar']], credentialsId: '', groupId: 'com.example', nexusUrl: '172.22.0.3:8081', nexusVersion: 'nexus3', protocol: 'http', repository: 'project_devops', version: '0.0.1-SNAPSHOT'
}
